...
class ClassifyResnet(object):
    def __init__(self, resnetSize, num_classes, training = False, data_format=None):
        self.resnetSize = resnetSize
    ...
    def inference(self, images, keep_prob):
        """
        Resnet classification convolutional neural network
    ...
    def loss(self, images, labels, dropout_keep_prob):
