...
parser.add_argument('--inmodel', type=str, default='./saved_model/1590079056', help='Model path')
parser.add_argument('--outmodel', type=str, default='./tflite/1590079056_int8.tflite', help='Model path')
...
def main(FLAGS):
    ...
    converter = tf.lite.TFLiteConverter.from_saved_model('./saved_model/1590079056')
    ...
    open("./tflite/1590079056_int8.tflite", "wb").write(tflite_model)
    stream = os.popen('edgetpu_compiler ./tflite/1590079056_int8.tflite -o ./etpu')
