...
parser.add_argument('--inmodel', type=str, default='./saved_model/1589806577', help='Model path')
parser.add_argument('--outmodel', type=str, default='./tflite/1589806577_int8.tflite', help='Model path')
...
def main(FLAGS):
    ...
    converter = tf.lite.TFLiteConverter.from_saved_model('./saved_model/1589806577')
